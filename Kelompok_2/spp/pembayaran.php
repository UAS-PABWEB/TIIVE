...
<form class="form-inline" role="form" method="post" action="./admin.php?hlm=bayar">
  ...
  <div class="form-group">
	...
	<div class="input-group">
		...
		<input type="txt" class="form-control" id="jml" name="jml" placeholder="60000">
	</div>
  </div>
...
<?php
		...
		if(mysql_num_rows($qbayar) > 0){
            ...
            echo ' <a href="./cetak.php?nis='.$nis.'" target="_blank" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a>';
				echo '</td></tr>';
