...
<html lang="en">
    <head>
        ...
        <meta name="desccription" content="Aplikasi Pendaftaran UKM STMIK Sumedang dengan PHP 7, MySQLi, dan Bootstrap 4">
        <meta name="keywords" content="Aplikasi Pendaftaran UKM STMIK Sumedang dengan PHP 7, MySQLi, dan Bootstrap 4">
        ...
        <title>Pendaftaran UKM STMIK Sumedang</title>
    </head>
    <body>
        <div class="container-fluid">
            <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
             <h5 class="my-0 mr-md-auto font-weight-normal"><i class="fas fa-user title-icon"></i> Pendaftaran UKM STMIK Sumedang</h5>
            </div>
        </div>
