...
if (isset($_GET['nim'])) { 
    ...
    $nim    = $_GET['nim']; 
    $query  = mysqli_query($db, "SELECT * FROM tbl_pendaftaran WHERE nim='$nim'") or die('Query Error : '.mysqli_error($db)); 
                    ...
                    <div class="row"> 
                        <div class="col"> 
                            ...
                            <div class="form-group col-md-12"> 
                                <label>NIM</label> 
                                <input type="text" class="form-control" name="nim" maxlength="10" autocomplete="off" value="<?php echo $nim; ?>" readonly required> 
                        ...
                        <div class="form-group col-md-12"> 
                            ...
                            <select class="form-control" name="program_studi" autocomplete="off" required> 
                                <option value="<?php echo $program_studi; ?>"><?php echo $program_studi; ?></option>
                                <option value=""></option>
                    ...
                    <div class="col"> 
                        ...
                        <div class="form-group col-md-12">
                                ...
                                <select class="form-control" name="pilih_ukm" autocomplete="off" required>
                                    <option value="<?php echo $pilih_ukm; ?>"><?php echo $pilih_ukm; ?></option>
                                    <option value=""></option> 
